...
assert.match(html, /id="status"[^>]+aria-live="polite"/, "non-fatal status must be announced");
...
assert.match(html, /<dialog[^>]+aria-labelledby="courseDialogTitle"/, "dialog needs an accessible name");
